...
public class ModParticles {
	...
	public static void registerProviders() {
		ParticleFactoryRegistry.getInstance().register(net.p3pp3rf1y.sophisticatedstorage.init.ModParticles.TERRAIN_PARTICLE.get(), spriteSet -> new CustomTintTerrainParticle.Factory());
	}
}
