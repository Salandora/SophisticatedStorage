...
public class StorageToolItem extends ItemBase {
	...
	@Override
	public InteractionResult sophisticatedCore_onItemUseFirst(ItemStack tool, UseOnContext context) {
		...
		return super.sophisticatedCore_onItemUseFirst(tool, context);
	}
	...
	public enum Mode implements StringRepresentable {
		...
		public static final StreamCodec<FriendlyByteBuf, Mode> STREAM_CODEC = StreamCodecHelper.enumCodec(Mode.class);
