...
public class HopperUpgradeContainer extends UpgradeContainerBase<HopperUpgradeWrapper, HopperUpgradeContainer> {
	...
	private void addInputFilterSlot(Slot slot) {
		slot.sophisticatedCore_setBackground(EMPTY_INPUT_FILTER_SLOT_BACKGROUND.getFirst(), EMPTY_INPUT_FILTER_SLOT_BACKGROUND.getSecond());
		slots.add(slot);
	}

	private void addOutputFilterSlot(Slot slot) {
		slot.sophisticatedCore_setBackground(EMPTY_OUTPUT_FILTER_SLOT_BACKGROUND.getFirst(), EMPTY_OUTPUT_FILTER_SLOT_BACKGROUND.getSecond());
		slots.add(slot);
	}
